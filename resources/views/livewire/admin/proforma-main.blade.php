            ...
            <table class="w-full table-auto">
              <thead class="bg-indigo-500 text-gray-200 border-b border-black">
                <tr class="text-left text-xs font-bold uppercase">
                    ...
                    <td scope="col" class="px-6 py-3">Vehiculo</td>
                    <td scope="col" class="px-6 py-3">VehiculoCliente</td>
                    ...
                    <td scope="col" class="px-6 py-3">Fecha_de_emision</td>
                    <td scope="col" class="px-6 py-3">subtotal</td>
                    <td scope="col" class="px-6 py-3">impuestos</td>
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                <tr class="text-sm font-medium text-gray-900 even:bg-gray-100 odd:bg-white hover:bg-indigo-100">
                  ...
                  <td class="px-6 py-4 text-xs">{{ optional($item->cliente)->nombre ?? 'No disponible' }}</td>
                  ...
                  <td class="px-6 py-4 text-xs">{{$item->impuestos}}</td>
                  <td class="px-6 py-4 text-xs">{{$item->total}}</td>
