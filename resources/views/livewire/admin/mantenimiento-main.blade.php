...
<div class="py-2">
    <div class="mx-6 mb-4">
        <h2 class="text-3xl font-bold text-gray-800">Mantenimientos</h2>
        ...
        <div class="flex items-center justify-between gap-1">
            <div class="w-full flex gap-2">
                ...
                <div class="mb-2 w-2/4">
                    <x-input wire:model.live="search" icon="user" placeholder="Buscar mantenimiento"/>
                </div>
                <!--Filtros   -->
            ...
            <div class="mb-1 ml-10">
                ...
                @if($isOpen)
                    @include('livewire.admin.mantenimiento-create')
                @endif
            </div>
        </div>
            ...
            <table class="w-full table-auto">
              <thead class="bg-indigo-500 text-gray-200 border-b border-black">
                <tr class="text-left text-xs font-bold uppercase">
                    ...
                    <td scope="col" class="px-6 py-3">Costo</td>
              ...
              <tbody class="divide-y divide-gray-200">
                ...
                <tr class="text-sm font-medium text-gray-900 even:bg-gray-100 odd:bg-white hover:bg-indigo-100">
                  ...
                  <td class="px-6 py-4 text-xs">{{$item->descripcion}}</td>s
                  <td class="px-6 py-4 text-xs">{{$item->costo}}</td>
